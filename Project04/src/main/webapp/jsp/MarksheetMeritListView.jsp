...
<%@page import="com.rays.project4.controller.MarksheetMeritListCtl"%>
...
<body>
<jsp:useBean id="bean" class="com.rays.project4.bean.MarksheetBean" scope="request" ></jsp:useBean>
