...
<%@page import="com.rays.project4.controller.UserRegistrationCtl"%>
...
<body>
    <jsp:useBean id="bean" class="com.rays.project4.bean.UserBean" scope="request"></jsp:useBean>
  ...
  <%--                  
   <% System.out.println("=============)))))"+bean.getFirstName());%>  --%>
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter valid Email-Id" size="26" value="<%=DataUtility.getStringData(bean.getLogin())%>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" id="datepicker" readonly="readonly" size="26" placeholder="Enter Dob "  value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 
				...
				<tr><th style="padding: 3px"></th><td></td></tr>
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="mobileNo" placeholder="Enter Mobile No"  size="26" maxlength="10" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
