...
<%@page import="com.rays.project4.controller.CourseCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.project4.bean.CourseBean" scope="request"></jsp:useBean>
...
<table>
	...
	<td><input type="text" name ="name" placeholder="Enter Course Name" size="31" value="<%=DataUtility.getStringData(bean.getName()) %>">
...
<tr><th style="padding: 3px"></th></tr>	
	...
	<td><input type="text" name ="description" placeholder="Enter Description" size="31" value="<%=DataUtility.getStringData(bean.getDescription())%>">
