<%@page import="com.rays.project4.Model.TimeTableModel"%>
<%@page import="com.rays.project4.controller.TimeTableListCtl"%>
<%@page import="com.rays.project4.Util.DataUtility"%>
<%@page import="com.rays.project4.Util.HTMLUtility"%>
<%@page import="com.rays.project4.bean.TimeTableBean"%>
...
<body >
<jsp:useBean id="bean" class="com.rays.project4.bean.TimeTableBean" scope="request"></jsp:useBean>
