...
<%@page import="com.rays.project4.controller.SubjectListCtl"%>
<%@page import="com.rays.project4.Util.ServletUtility"%>
<%@page import="com.rays.project4.bean.SubjectBean"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project4.Model.SubjectModel"%>
...
<body>
	...
	<div align="center">
		...
		<jsp:useBean id="bean" class="com.rays.project4.bean.SubjectBean"
