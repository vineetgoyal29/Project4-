...
import com.rays.project4.Model.RoleModel;
import com.rays.project4.Model.UserModel;
import com.rays.project4.Util.DataUtility;
import com.rays.project4.Util.DataValidator;
import com.rays.project4.Util.PropertyReader;
import com.rays.project4.Util.ServletUtility;
import com.rays.project4.bean.BaseBean;
import com.rays.project4.bean.RoleBean;
...
public class LoginCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_LOG_OUT.equals(op) && !OP_SIGN_IN.equals(op)) {
			System.out.println("Do get 11111111");
			 ...
			 * return; }
			 */
		System.out.println("Don get 222222222");
		ServletUtility.forward(getView(), request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SIGN_IN.equalsIgnoreCase(op)) {
			...
			try {
				...
				if (bean != null) {
					...
					if (rolebean != null) {
					  ...
					  if (str == null) { ServletUtility.redirect(ORSView.WELCOME_CTL, request,
					  response); return; } else { ServletUtility.redirect(str, request, response);
					  return; }
					 
				} else {
					System.out.println(" Lctl Dp post 333333");
					bean = (UserBean) populateBean(request);
					ServletUtility.setBean(bean, request);
					ServletUtility.setErrorMessage("Invalid Log"
							+ "inId And Password", request);
				}
			...
			System.out.println(" Lctl Do post 44444");
			...
			System.out.println("L ctl Do post 555555");
