<%@page import="com.rays.project4.Model.StudentModel"%>
<%@page import="com.rays.project4.Util.ServletUtility"%>
<%@page import="com.rays.project4.Util.HTMLUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project4.bean.StudentBean"%>
<%@page import="com.rays.project4.controller.StudentListCtl"%>
...
<body>
<jsp:useBean id="cbean" class="com.rays.project4.bean.CollegeBean" scope="request" ></jsp:useBean>
<jsp:useBean id="bean" class="com.rays.project4.bean.StudentBean" scope="request" ></jsp:useBean>
