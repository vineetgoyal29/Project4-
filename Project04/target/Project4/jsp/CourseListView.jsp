...
<%@page import="com.rays.project4.Model.CourseModel"%>
<%@page import="com.rays.project4.Util.HTMLUtility"%>
<%@page import="com.rays.project4.controller.CourseListCtl"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project4.bean.CourseBean"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project4.controller.CourseCtl"%>
<%@page import="com.rays.project4.Util.ServletUtility"%>
<%@page import="com.rays.project4.controller.ORSView"%>
