<%@page import="com.rays.project4.Model.CollegeModel"%>
<%@page import="com.rays.project4.Model.UserModel"%>
<%@page import="com.rays.project4.bean.CollegeBean"%>
...
<%@page import="com.rays.project4.controller.CollegeListCtl"%>
...
<body>
<jsp:useBean id="bean" class="com.rays.project4.bean.CollegeBean" scope="request" ></jsp:useBean>
