...
<%@page import="com.rays.project4.Model.MarksheetModel"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project4.Util.ServletUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.project4.bean.MarksheetBean"%>
<%@page import="com.rays.project4.controller.MarksheetListCtl"%>
...
<body>
	<jsp:useBean id="bean" class="com.rays.project4.bean.MarksheetBean"
	...
	<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="POST">
		...
		System.out.println(l.size() + "on reelease" );
...
<%=HTMLUtility.getList("rollNo",String.valueOf(bean.getId()),l) %>					&nbsp; <input type="submit" name="operation"
