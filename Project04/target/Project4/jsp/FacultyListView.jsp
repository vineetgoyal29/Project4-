<%@page import="com.rays.project4.Model.FacultyModel"%>
<%@page import="com.rays.project4.bean.FacultyBean"%>
<%@page import="com.rays.project4.Util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.project4.controller.FacultyListCtl"%>
...
<jsp:useBean id="bean" class="com.rays.project4.bean.FacultyBean" scope="request"></jsp:useBean>
<jsp:useBean id="colbean" class="com.rays.project4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="com.rays.project4.bean.CourseBean" scope="request"></jsp:useBean>
